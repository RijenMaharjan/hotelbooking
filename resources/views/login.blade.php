...
<body class="bg-gradient-primary">
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="{{url('admin/login')}}">
                                      @csrf
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control form-control-user" @if(Cookie::has('adminpwd')) value="{{Cookie::get('adminpwd')}}" @endif
    ...
    <script src="{{asset('js/sb-admin-2.min.js')}}{{asset('"></script>
