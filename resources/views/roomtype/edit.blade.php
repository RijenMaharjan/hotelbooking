                              ...
                              <form enctype="multipart/form-data" method="post" action="{{url('admin/roomtype/'.$data->id)}}">
                                ...
                                <table class="table table-bordered">
                                  <tr>
                                   ...
                                   <tr>
                                    <th>Price</th>
                                    <th><input value="{{$data->price}}" name="price" type="number" class="form-control"></th>
                                  </tr>
                                  <tr>
                                    <th>Details</th>
                                    <th><textarea name="detail" class="form-control">{{$data->detail}}</textarea></th>
                                  </tr>
                                  <tr>
                                    <th>Gallery Images</th>
                                    <th>
                                      <table class="table tablebordered mt-2">
                                        <tr>
                                          ...
                                          @foreach($data->roomtypeimgs as $img)
                                            <td class="imgcol{{$img->id}}">
                                              ...
                                              <p class="mt-2">
                                                <button type="button" onclick="return confirm('Are you sure you want to delete this image??')" class="btn btn-danger btn-sm delete-image" data-image-id="{{$img->id}}">
